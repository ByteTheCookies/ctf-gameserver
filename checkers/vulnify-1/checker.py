...
def put_flag(host, flag):
    try:
        ...
        flag_id = {"username": username}

        password = rand_str(random.randint(1, 30))

        pl_name = 'Mix %s' % rand_str(10)
        pl_desc = flag
        num_songs = random.randint(1, 23)
        songs = [rand_str(random.randint(1, 31)).encode() for _ in range(num_songs)]
...
class Vulnify1Checker(checkerlib.BaseChecker):
    def place_flag(self, tick):
        ...
        try:
            ...
            logging.exception("vulnify-1 place_flag failed")
            return checkerlib.CheckResult.DOWN
    ...
    def check_service(self):
        try:
            ...
            logging.exception("vulnify-1 check_service failed")
            return checkerlib.CheckResult.DOWN
    ...
    def check_flag(self, tick):
        ...
        try:
            ...
            logging.exception("vulnify-1 check_flag failed")
            return checkerlib.CheckResult.DOWN


if __name__ == '__main__':
    checkerlib.run_check(Vulnify1Checker)
