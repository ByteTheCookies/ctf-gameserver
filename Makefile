...
infra_up:
	...
	sudo docker compose --profile checker up -d checker_ccforms_1 checker_ccforms_2 checker_vulnify_1 checker_vulnify_2 checker_swink_1 --build
...
infra_down:
	...
	sudo docker compose --profile checker down checker_ccforms_1 checker_ccforms_2 checker_vulnify_1 checker_vulnify_2 checker_swink_1 --remove-orphans
